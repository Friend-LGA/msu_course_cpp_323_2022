...
class Graph {
 public:
  ...
  VertexId get_lastVertexId()
  {return last_vertex_id_;}
  EdgeId get_lastEdgeId()
  ...
  VertexId get_from_vertexid(EdgeId i)
  {return edges_[i].from_vertex_id();}
  VertexId get_to_vertexid(EdgeId i)
  {return edges_[i].to_vertex_id();}
 private:
  struct Vertex {
   public:
